...
public class showownestController {
    ...
    public void initialize(){
        indice %= window.getOwnerbiens().size();
        Bien b = window.getOwnerbiens().get(indice);
        if (b.isVisibilite()){
    ...
    public void delete(ActionEvent event) {
        ((Stage) (showEstBtn.getScene().getWindow())).close();
        window w = new window();
        Bien b = biensAfficher.get(indice);
        w.getAgence().suprimerBien(b);
